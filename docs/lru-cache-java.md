...
[`src/main/java/com/bichel/systemdesign/LRUCache.java`](https://github.com/YauhenBichel/Algorithms-and-data-structures/blob/main/src/main/java/com/bichel/systemdesign/LRUCache.java) on GitHub.
