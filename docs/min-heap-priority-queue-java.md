---
title: "Min-Heap and Priority Queue in Java"
description: "Binary min-heap implemented in Java - insert, extractMin in O(log n) and buildHeap in O(n). Source code with complexity analysis."
category: "Data Structures"
---

# Min-Heap and Priority Queue in Java

<span class="tag">Data Structures</span><span class="tag">Java</span>

A binary heap is a complete tree kept in an array, where every parent compares less than or equal to its children. Sift-up restores the invariant after an insert, sift-down after a removal. Building from an unordered array bottom-up costs O(n), not O(n log n) - the standard surprising result.
